...
const TICK_THROTTLE_MS = 32; // ~30fps cap
const RAMP_INTERVALS = [120, 90, 65, 45, 30, 18]; // accelerating haptic pattern
...
export function useHaptics() {
  ...
  /** Light tick — used during carousel scroll or slider drag (throttled to ~30fps) */
  ...
  /** Medium click — fired when tapping YES/NO on a card */
  ...
  /** Start ramping haptics for swipe-up-to-trade (accelerating vibration) */
